                ...
                <View style={{
                    ...
                    <View style={{}}>
                        <Image source={require('./A1.png')}
                            style={{ position: 'absolute', alignSelf: 'center', width, height: 130, resizeMode: 'contain', margin: 115 }} />
                                    ...
                                    <View style={{ flexDirection: "row", margin: 0 }}>
                                        ...
                                        <View style={{ height: 100, width: 117, margin: 0, alignSelf: 'center' }}>
                                            <TouchableOpacity style={{ alignSelf: 'center' }} onPress={() => this.setState({
                                                ...
                                                <View style={{ position: 'absolute', alignSelf: 'flex-end', height: 20, width: 24, margin: 79 }}>
                                                    <Icon name="camera" color="black" size={18} />
                                                </View>
                                            </TouchableOpacity>
                                        </View>
