    ...
    render() {
        return (
            <View style={styles.container}>
                ...
                <TouchableOpacity style={styles.flagBtn} onPress={() => this.setState({ langModal: true })}>
                    <Image source={require('./en.jpg')} style={styles.flag} />
                </TouchableOpacity>
                ...
                >
                    ...
                    <View style={{ backgroundColor: '#fff', position: 'absolute', flex: 1, alignSelf: 'center', marginTop: 200, borderRadius: 10, paddingVertical: 5 }}>
                        ...
                        <View style={{ alignSelf: 'center', width: width - 100, flexDirection: 'row', justifyContent: 'space-around', alignItems: 'center', padding: 30 }}>
                            ...
                            <TouchableOpacity onPress={() => !this.setState({ langModal: false }) ? this.props.navigation.navigate('App') : null}>
                                <Image source={require('./th.png')} style={styles.flagInModal} />
                            </TouchableOpacity>

                            <TouchableOpacity onPress={() => this.setState({ langModal: false })}>
